...
var GeektAddress = '0xa7b3058152165c72a4dd7c4812c5964f1c26f00d';
...
class App extends Component {
  ...
  checkImage(mine,imageHash){
    ...
    var proxyURL='https://cors-anywhere.herokuapp.com/'+thisURL;
  ...
  fetchNewImage() {  // when URL is pasted into newImage box, simple error-check, display, and get SHA256 hash of the image also
    ...
    var myImage =this.refs.myImageRef;
    var proxyURL='https://cors-anywhere.herokuapp.com/'+this.state.newImageURL;
    if(isNewImage){
      outerThis.setState({
